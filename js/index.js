...
<main>
    ...
    <section class="hero">
        <div class="container hero-inner">
            <div>
                <h1 class="title">Pool rides or hire privately — passenger and cargo, in one app</h1>
                <p class="subtitle">Tripzey digitizes everyday movement. Share a ride, offer seats, or book a private vehicle — from bikes and cars to vans and trucks. Real‑time matching, transparent fares, and safety at the core.</p>
                <div class="cta">
                    <a class="btn primary" href="#features">See what’s inside</a>
                    <a class="btn ghost" href="#how">How it works</a>
                </div>
                <div class="stores">
                    <a class="store-btn" href="https://play.google.com/store/apps/details?id=com.tripzey" rel="noopener">
                        <span>Google Play<br/><small>Get it on</small></span>
                    </a>
                    <a class="store-btn" href="https://apps.apple.com/app/id000000000" rel="noopener">
                        <span>App Store<br/><small>Download on the</small></span>
                    </a>
                </div>
            </div>
    ...
    <section id="features">
        <div class="container">
            ...
            <p class="section-sub">All‑type vehicle pooling and private rides for people and goods.</p>
            <div class="grid-3">
                <div class="card">
                    <div class="icon">🚗</div>
                    <h3>Pool passenger rides</h3>
                    <p>Request a seat or offer your spare seats for daily commutes and inter‑city trips.</p>
                </div>
                <div class="card">
                    <div class="icon">🛻</div>
                    <h3>Hire cargo vehicles</h3>
                    <p>Post a cargo job and match with nearby vans, pickups, or trucks in minutes.</p>
                </div>
                <div class="card">
                    <div class="icon">🔒</div>
                    <h3>Private full‑vehicle hire</h3>
                    <p>Book the entire vehicle for yourself or your business with upfront pricing.</p>
                </div>
                <div class="card">
                    <div class="icon">📍</div>
                ...
                <div class="card">
                    <div class="icon">💳</div>
                    <h3>Cash or digital</h3>
                    <p>Pay the way you like — cash, UPI, or cards where supported.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="steps">
                <div class="step">
                    <div class="num">1</div>
                    <h3>Set your trip</h3>
                    <p>Enter pickup, drop, seats or cargo type, and timing.</p>
                </div>
                <div class="step">
                    <div class="num">2</div>
                    <h3>Choose mode</h3>
                    <p>Pool with others, offer seats, or hire a full vehicle.</p>
                </div>
                <div class="step">
                    <div class="num">3</div>
                    <h3>Match & chat</h3>
                ...
                <div class="step">
                    <div class="num">4</div>
                    <h3>Ride safely</h3>
                    <p>Track live, share trip, rate and review afterwards.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="safety">
        <div class="container">
            ...
            <p class="section-sub">Verified profiles, trip sharing, SOS, and community ratings.</p>
            <div class="grid-3">
                <div class="card">
                    <div class="icon">✅</div>
                    <h3>KYC & verification</h3>
                    <p>Profile checks for drivers and riders to keep the network trusted.</p>
                </div>
                <div class="card">
                    <div class="icon">🆘</div>
                    <h3>SOS & sharing</h3>
                    <p>Share live trip with trusted contacts and access SOS when needed.</p>
                </div>
                <div class="card">
                    <div class="icon">⭐</div>
                    <h3>Ratings & reviews</h3>
                    <p>Two‑way feedback keeps quality high and experiences transparent.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="faq">
        <div class="container">
            ...
            <details class="faq">
                <summary>Is Tripzey for both people and goods?</summary>
                <p>Yes. Tripzey supports passenger pooling and private/cargo hire across vehicle types.</p>
            </details>
            <details class="faq">
            ...
            <details class="faq">
                ...
                <p>You can pay in cash or digitally where supported. Digital options vary by region.</p>
            </details>
        </div>
    </section>
...
<script type="application/ld+json">
    {
        ...
        "description": "Pool rides or hire privately for passenger and cargo vehicles.",
        "url": "https://tripzey.starmobilebsl.in/",
